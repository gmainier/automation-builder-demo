...
interface MetaProps extends SVGProps<SVGSVGElement> {
  grayscale?: boolean;
}

const Meta = ({ grayscale = true, ...props }: MetaProps) => {
  const gradientId = React.useId().replace(/:/g, "");
  const horizontalGradientId = `${gradientId}-meta-a`;
  const verticalGradientId = `${gradientId}-meta-b`;
      ...
      style={
        {
          ...
          "--meta-primary": "#0081fb",
          "--meta-secondary": "#0064e1",
        } as React.CSSProperties
      }
      {...props}
    >
      <path
        fill="var(--meta-primary)"
      ...
      >
        <stop offset="0" stopColor="var(--meta-primary)" />
        <stop offset=".995" stopColor="var(--meta-secondary)" />
      </linearGradient>
      <path
