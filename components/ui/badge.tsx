  ...
  "inline-flex items-center whitespace-nowrap justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        violet: "border-violet-500 bg-violet-50 text-violet-700 dark:bg-violet-900/40 dark:text-violet-300",
        blue: "border-blue-500 bg-blue-500 text-white",
        pink: "border-red-500 bg-red-50 text-pink-800 dark:bg-pink-900/40 dark:text-red-200",
        amber: "border-yellow-500 bg-amber-50 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300",
        sky: "border-sky-900 bg-sky-900 text-white",
        black: "border-black bg-black text-white",
        gray: "border-zinc-300 bg-zinc-100 text-zinc-900 dark:bg-zinc-700 dark:text-zinc-300",
        neutral: "border-gray-400 text-gray-500",
        rainbow: "bg-linear-to-r from-violet-600 to-pink-600 text-white border-transparent",
