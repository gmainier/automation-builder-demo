...
const switchVariants = cva(
  `
    relative peer inline-flex shrink-0 cursor-pointer items-center rounded-full border border-transparent
    shadow-[inset_0_0_0_1px_hsl(var(--border)/0.55)] transition-[background-color,border-color,box-shadow,transform]
    duration-400 [transition-timing-function:cubic-bezier(0.22,1,0.36,1)] hover:shadow-[inset_0_0_0_1px_hsl(var(--border)/0.75)]
...
const switchThumbVariants = cva(
  `pointer-events-none block bg-white w-1/2 h-[calc(100%-4px)] shadow-md ring-0 start-0 will-change-transform transition-[transform,box-shadow]
  duration-250 [transition-timing-function:cubic-bezier(0.22,1,0.36,1)] motion-reduce:transition-none
  data-[state=unchecked]:translate-x-[2px] data-[state=checked]:translate-x-[calc(100%-2px)]
  data-[state=checked]:shadow-lg rtl:data-[state=unchecked]:-translate-x-[2px] rtl:data-[state=checked]:-translate-x-[calc(100%-2px)]`,
  {
    variants: {
      shape: {
        pill: "rounded-full",
