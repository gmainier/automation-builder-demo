...
export default function Home() {
  ...
  const [activeTab, setActiveTab] = useQueryState("tab", parseAsString.withDefault("automations"));
    ...
    const fetchCounts = async () => {
      try {
        const [pendingRes, activeRes] = await Promise.all([
          fetch("/api/automation/approval/pending", { signal: controller.signal }),
          ...
          <div className="flex h-full flex-col">
            ...
            <div className="flex-1 overflow-hidden min-h-0 flex flex-col">
              {activeTab === "automations" ? (
                ...
                <AutomationTemplatesTab onUseTemplate={(id) => handleOpenAutomation(id)} />
              ) : activeTab === "active" ? (
                <ActiveAutomationsTab onCountChange={setActiveCount} onOpenAutomation={handleOpenAutomation} />
              ) : activeTab === "approvals" ? (
            ...
            <div className="flex flex-1 overflow-hidden min-h-0">
              ...
              {assistantOpen && (
                <AssistantPanelShell
                  ...
                  seedMode={assistantSeedMode === "suggest" ? "suggest" : "build"}
                  onSeedConsumed={() => {
                    setAssistantSeed(null);
                    setAssistantSeedMode(null);
                  }}
